//Listening (prints anything the user selects in the drop down menu even if they don't push the button)
...
public class JavaFxPracticeListeningForSelectionChanges extends Application{
	Stage window;
	Scene scene;
	Button button;
